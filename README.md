...
```html
<script src="https://twemoji.maxcdn.com/v/13.0.1/twemoji.min.js" integrity="sha384-ZX2gBGeJ0pzDe1TIPYJ9HLTozuXwJTEW67X8BXHl+f3ysUPwHxbf9nI2D+XJLp7b" crossorigin="anonymous"></script>
```
