...
```html
<script src="https://twemoji.maxcdn.com/v/13.0.1/twemoji.min.js" integrity="sha384-ILlSMVJxp88xDj/8ds0m18lHOdSuf33UF1xlhtU4+dXNbeBQ2GNj6Y+hSIAGbpJu" crossorigin="anonymous"></script>
```
